...
double[] lineData1 = InputLineData(LINE11);
...
double[] InputLineData(int numberOfline)
{
    ...
    lineData[CONTSTANT] = Prompt($"Введите константу для {numberOfLine} прямой");
...
bool ValidateLines(double[] lineData1, double[] lineData2)
{
    ...
    {
        if (lineData1[CONTSTANT] == lineData2[CONTSTANT])
        {
